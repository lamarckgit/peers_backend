...
class LicenseManager:
    ...
    # def ensure_constants(self, retries=5, retry_delay=5):
    #     """Attempt to ensure constants are loaded, retrying if necessary."""
    #     attempt = 0
    ...
    #                 self.initial_registration()
    #             except Exception as e:
    #                 print(f"ERROR: Initial registration failed: {e}")
    #                 attempt += 1
    ...
    #             return
    #         except Exception as e:
    #             print("ERROR: Could not decrypt constants.json.enc:", str(e))
    #             print("Re-running initial registration...")
    ...
    #                 print(f"ERROR: Initial registration failed: {e2}")
    #                 attempt += 1
    #                 time.sleep(retry_delay)
    #                 continue
    #             # After re-registration, try to load again on next loop
    #         attempt += 1
    #     # If all attempts fail
    #     raise RuntimeError("Could not load or register license after multiple attempts.")
